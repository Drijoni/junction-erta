...
<div class="flex flex-col">
    <div class="flex flex-row w-full h-12 bg-white rounded-md items-center justify-between px-4 mt-4">
        ...
        <button class="px-2 py-1.5 bg-cyan-500 rounded-md text-white font-">Create new Project  </button>
    </div>
...
<div class="departamentList mt-4">

<div class="max-w-md bg-white rounded-md shadow-md overflow-hidden md:max-w-sm relative">
    <div class="px-6 py-6">
      <div class="text-sm text-gray-500">
        Deadline: <time datetime="2022-01-01">2022-01-01</time>
      </div>
      <div class="flex flex-col my-4">
        ...
        <div class="text-center text-gray-500">
            Where your idea becomes reality
        </div>
      </div>
      <div class="mt-2">
      ...
      <div class="absolute bottom-7 right-10  text-black px-2 py-1 rounded">
        Priority :    <span class="text-red-500">High</span>
      </div>
    </div>
</div>
